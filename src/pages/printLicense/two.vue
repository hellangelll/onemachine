    ...
    export default {
        ...
        methods: {
            ...
            repeatCheckFace(){
                ...
                setTimeout(function(){
                    if(me.showFaceInfo == '2'){
                        me.showFaceInfo = '1'
                    }
                },7000)
                setTimeout(function(){
                    if(me.showFaceInfo == '1'){
                        me.showFaceInfo = '0'
                    }
                },8000)
                setTimeout(function(){
                    if(me.showFaceInfo == '0'){
                        me.showFaceInfo = ''
                    }
                },9000)
            },
            ...
            doFaceRecognition() {
                ...
                me.$http.post('/licenses/query',
                {
                    ...
                    me.doFaceRecognitionSucess = true;
                    window.external.soundPlayer_stop();
                ...
                // 播放左转，右转
                setTimeout(function(){
                    if(me.doFaceRecognitionSucess == false){
                        window.soundPlayer8();
                    }
                },500)
                setTimeout(function(){
